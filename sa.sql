...
(34, 'A社課', '2023-12-01 10:00:00', 60, '12/01 星期五 10:00 - 12/01 星期五 12:00', '台北'),
(35, '社課B', '2024-01-01 22:00:00', 60, '01/01 星期一 22:00 - 01/02 星期二 00:00', '台北'),
(36, 'C社課', '2023-12-29 10:00:00', 60, '12/29 星期五 10:00 - 12/29 星期五 12:00', '台北');
...
(49, '管理者', 'admin@gmail.com', '11111111a', '0903694286', '無', '2023-12-27 09:34:24', '2'),
(60, '老師A', 'teacherA@gmail.com', '11111111a', '0903694286', '無', '2023-12-28 14:07:39', '3'),
(61, 'A學生', 'studentA@gmail.com', '11111111a', '0903694286', '銅管', '2023-12-28 14:13:05', '1');
...
--
-- 傾印資料表的資料 `tbl_paid_record`
--

INSERT INTO `tbl_paid_record` (`paid_sequence`, `paid_time`, `paid_fee`, `member_id`) VALUES
(2026418225, '2023-12-28 22:13:08', 1000, 61);
...
--
ALTER TABLE `tbl_borrow_record`
  MODIFY `borrow_record_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
...
--
ALTER TABLE `tbl_course_registration_record`
  MODIFY `course_registration_record_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=383;
